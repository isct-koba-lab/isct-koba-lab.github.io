...
小林研では, オペレーションズ･リサーチ, 数理最適化, 機械学習に関する研究を行っています. これらは数理的に面白い分野でありながら, 実社会における様々な問題解決にも貢献できるという魅力もあります. ただし複雑な問題を数理的な手法で解決するにあたっては，各種手法の数理的な背景や原理を深く理解していることが必要不可欠であることは言うまでもありません．したがって小林研では現実の応用を見据えつつも，理論的な側面を重視した研究を進めています．研究は一朝一夕に成果が出るものではなく，日々の地道な試行錯誤が必要です．こうした研究に伴う苦労を厭わず，粘り強く課題に取り組むことのできる意欲的な学生を歓迎します．
