...
- 研究室配属にあたって必要な前提知識はありますか?
  - 研究では学部 1 年次に学ぶ線形代数, 微積を頻繁に使います. また本学経営工学系 2, 3 年次の関連科目（OR基礎、OR応用、モデル化とOR、経営経済のためのデータ分析）で扱われる話題に馴染みがあることを前提として議論することも多いです. そのため, これらの話題に対する興味と一定の理解力があることが望ましいでしょう. 自習する場合は, 以下にあげる関連書籍･資料を参考にしてください:
...
- 研究テーマはどのように決めますか?
  - まず学生がテーマを探し, ゼミの場などでの議論を通じて詳細を決定します. 小林が一方的にテーマを設定することはなく, 学生の興味と意志を尊重する形で一緒に検討します.
